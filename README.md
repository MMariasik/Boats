...
# Creating lobby
![Alt text](/screenshots/boats2.png?raw=true "Lobby")
# Arranging your ships
![Alt text](/screenshots/boats3.png?raw=true "Arrange")
# Gameplay
![Alt text](/screenshots/boats4.png?raw=true "Gameplay")
# Hitting enemy's ship
![Alt text](/screenshots/boats5.png?raw=true "Hit")
![Alt text](/screenshots/boats6.png?raw=true "HitMessage")
# Sunken ship picture (smaller map)
![Alt text](/screenshots/boats7.png?raw=true "sunken")
